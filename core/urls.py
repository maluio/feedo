...
urlpatterns = [
    ...
    path('feeds/forward-to-next-feed', views.forward_to_next_feed, name='forward_to_next_feed'),
    ...
    path('articles/<int:feed_id>/read-all', views.article_read_all, name='article_read_all'),
]
